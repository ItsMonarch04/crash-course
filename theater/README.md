...
the ABI-1 scenario shape through serializable seed/profile URLs; native↔wasm
equivalence remains an owner-controlled CI gate until a browser toolchain is
available.
